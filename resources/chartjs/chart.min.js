...
(this, (function () {
        ...
        function ee(t, e, i, s, n, o = {}) {
            ...
            for (t.save(), t.font = n.string, function (t, e) {
                ...
                h = a[l], r && (o.strokeColor && (t.strokeStyle = o.strokeColor), $(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(h, i, s, o.maxWidth)), t.fillText(h, i, s, o.maxWidth), ie(t, i, s, h, o), s += n.lineHeight;
            t.restore()
        }
        ...
        function _i(t, e = "x") {
            ...
            !function (t, e, i) {
                ...
                h = mi(t, 0);
                for (let c = 0; c < s - 1; ++c)
                    l = h, h = mi(t, c + 1), l && h && (Tt(e[c], 0, pi) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
            }
            (t, n, o),
            function (t, e, i = "x") {
                const s = xi(i),
        ...
        function vi(t, e, i, s, n) {
            ...
            if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode)
                ...
                for (o = 0, a = t.length; o < a; ++o)
                    r = t[o], l = bi(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
            }
            e.capBezierPoints && function (t, e) {
                ...
                r = Gt(t[0], e);
                for (i = 0, s = t.length; i < s; ++i)
                    a = o, o = r, r = i < s - 1 && Gt(t[i + 1], e), o && (n = t[i], a && (n.cp1x = yi(n.cp1x, e.left, e.right), n.cp1y = yi(n.cp1y, e.top, e.bottom)), r && (n.cp2x = yi(n.cp2x, e.left, e.right), n.cp2y = yi(n.cp2y, e.top, e.bottom)))
            }
            (t, i)
        }
        const wi = t => 0 === t || 1 === t,
        ...
        function Ai(t, e, i) {
            return function (t, e) {
                ...
                let s = Oi.get(i);
                return s || (s = new Intl.NumberFormat(t, e), Oi.set(i, s)),
                s
            }
            (e, i).format(t)
        }
        ...
        function zi(t, e, i) {
            ...
            for (let t = c, i = c; t <= d; ++t)
                m = e[t % a], m.skip || (p = h(m[s]), p !== x && (b = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ii({
                                    start: _,
                                    end: t,
                                    loop: u,
                                    count: a,
        ...
        function ts(t, i, s) {
            ...
            return r.observe(o),
            function (t, e) {
                Zi.size || window.addEventListener("resize", Ji),
                Zi.set(t, e)
            }
            (t, a),
            r
        ...
        function es(t, e, i) {
            ...
            "resize" === e && function (t) {
                Zi.delete(t),
                Zi.size || window.removeEventListener("resize", Ji)
            }
            (t)
        }
        function is(t, i, s) {
        ...
        class ws {
            ...
            updateIndex(t) {
                this.index !== t && _s(this._cachedMeta),
                this.index = t
            }
            linkScales() {
                const t = this.chart,
            ...
            _resolveElementOptions(t, e = "default", i) {
                ...
                return f.$shared && (f.$shared = r, n[o] = Object.freeze(vs(f, r))),
                f
            }
        ...
        function Ps(t, e) {
            ...
            if (o > 0) {
                ...
                for (Ds(e, l, h, $(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++)
                    Ds(e, l, h, n[t], n[t + 1]);
                return Ds(e, l, h, r, $(s) ? e.length : r + s),
                l
            }
            return Ds(e, l, h),
            l
        ...
        class Es extends Ms {
            ...
            update(t, e, i) {
                ...
                this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), this._range = Ne(this, n, s), this._dataLimitsCached = !0),
            ...
            calculateLabelRotation() {
                ...
                c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Ts(t.grid) - e.padding - Ls(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = It(Math.min(Math.asin(Ht((h.highest.height + 6) / o, -1, 1)), Math.asin(Ht(a / r, -1, 1)) - Math.asin(Ht(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))),
            ...
            _calculatePadding(t, e, i, s) {
                ...
                if (this.isHorizontal()) {
                    ...
                    let c = 0,
                    d = 0;
                    r ? l ? (c = s * t.width, d = i * e.height) : (c = i * t.height, d = s * e.width) : "start" === n ? d = e.width : "end" === n ? c = t.width : (c = t.width / 2, d = e.width / 2),
                    ...
                    if (h = t[a].label, c = this._resolveTickFontOptions(a), i.font = d = c.string, u = s[d] = s[d] || {
                        ...
                        if (Y(h))
                            for (r = 0, l = h.length; r < l; ++r)
                                m = h[r], $(m) || Y(m) || (g = Yt(i, u.data, u.gc, g, m), p += f)
                    } else
                        g = Yt(i, u.data, u.gc, g, h), p = f;
                    n.push(g),
                    o.push(p),
                    x = Math.max(g, x),
                    b = Math.max(p, b)
            ...
            _computeGridLineItems(t) {
                ...
                for (m = 0; m < l; m += C) {
                    ...
                    x = As(this, m, a),
                    void 0 !== x && (b = Xt(i, x, e), r ? _ = v = M = S = b : y = w = k = P = b, c.push({
                            tx1: _,
                            ty1: y,
                            tx2: v,
                            ty2: w,
            ...
            drawBorder() {
                ...
                h,
                c;
                this.isHorizontal() ? (r = Xt(t, this.left, n) - n / 2, l = Xt(t, this.right, o) + o / 2, h = c = a) : (h = Xt(t, this.top, n) - n / 2, c = Xt(t, this.bottom, o) + o / 2, r = l = a),
                e.save(),
        ...
        class Is {
            ...
            register(t) {
                ...
                return n in s || (s[n] = t, function (t, e, i) {
                    ...
                    (t, o, i), this.override && xt.override(t.id, t.overrides)),
                o
            }
            get(t) {
                return this.items[t]
        ...
        class Fs {
            ...
            notify(t, e, i, s) {
                ...
                return "destroy" === e && (this._notify(n, t, "stop"), this._notify(this._init, t, "uninstall")),
                o
            }
            _notify(t, e, i, s) {
                s = s || {};
                for (const n of t) {
                    const t = n.plugin;
                    if (!1 === Q(t[i], [e, s, n.options], t) && s.cancelable)
                        return !1
                }
                return !0
            }
        ...
        function Us(t, e) {
            let i = $s.get(t);
            return i || (i = e(), $s.set(t, i), Ys.add(i)),
            i
        }
        const Xs = (t, e, i) => {
            const s = lt(e, i);
        ...
        class qs {
            ...
            datasetAnimationScopeKeys(t, e) {
                return Us(`${t}.transition.${e}`, (() => [[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]]))
            }
        ...
        class an {
            constructor(t, e) {
                ...
                nn[this.id] = this,
                l && h ? (a.listen(this, "complete", tn), a.listen(this, "progress", en), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item")
            }
            get aspectRatio() {
                const {
                    options: {
            ...
            buildOrUpdateScales() {
                ...
                J(n, (e => {
                        ...
                        a = Ns(o, n),
                        r = K(n.type, e.dtype);
                        void 0 !== n.position && Qs(n.position, a) === Qs(e.dposition) || (n.position = e.dposition),
                        s[o] = !0;
                        let l = null;
            ...
            buildOrUpdateControllers() {
                ...
                for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                    ...
                    if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || Ws(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller)
            ...
            _handleEvent(t, e) {
                ...
                r = !1,
                l = null;
                return "mouseout" !== t.type && (a = this.getElementsAtEventForMode(t, n.mode, n, o), l = "click" === t.type ? this._lastEvent : t),
                this._lastEvent = null,
                Gt(t, this.chartArea, this._minPadding) && (Q(s.onHover, [t, a, this], this), "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || Q(s.onClick, [t, a, this], this)),
                r = !tt(a, i),
        ...
        function mn(t, e, i, s) {
            ...
            (t);
            "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[xn(c, a, r, l)] = !0, n = h)),
            o[xn(n, a, r, l)] = !0,
            t.borderSkipped = o
        }
        function xn(t, e, i, s) {
            ...
            o,
            a;
            return s ? (a = i, t = bn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = bn(t, e, i),
            t
        }
        function bn(t, e, i) {
        ...
        class yn extends ws {
            ...
            _calculateBarValuePixels(t) {
                ...
                f !== d && (u = f - d, f = d),
                l && (d = r.barStart, f = r.barEnd - r.barStart, 0 !== d && Dt(d) !== Dt(r.barEnd) && (u = 0), u += d);
                const g = $(s) || l ? u : s;
            ...
            _calculateBarIndexPixels(t, e) {
                ...
                if (e.grouped) {
                    ...
                    a = i.getPixelForValue(this.getParsed(t)[i.axis], t), r = Math.min(o, e.min * e.ratio);
                return {
                    base: a - r / 2,
                    head: a + r / 2,
                    center: a,
                ...
                tooltip: {
                    callbacks: {
                        ...
                        label(t) {
                            ...
                            return Y(e) ? (e = e.slice(), e[0] += i) : e += i,
                            e
                        }
                    }
                }
        ...
        function Rn(t, e, i, s, n) {
            ...
            o.borderWidth && (a ? (t.lineWidth = 2 * o.borderWidth, t.lineJoin = "round") : (t.lineWidth = o.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function (t, e, i) {
                ...
                h = e.innerRadius + a;
                let c;
                for (i && On(t, e, o + _t), t.beginPath(), t.arc(s, n, h, o + _t, o, !0), c = 0; c < r; ++c)
                    t.stroke();
        ...
        class En extends Ms {
            ...
            draw(t) {
                ...
                s = (e.offset || 0) / 2,
                n = (e.spacing || 0) / 2;
                if (this.pixelMargin = "inner" === e.borderAlign ? .33 : 0, this.fullCircles = i > _t ? Math.floor(i / _t) : 0, 0 === i || this.innerRadius < 0 || this.outerRadius < 0)
                    return;
                t.save();
                let o = 0;
                if (s) {
        ...
        function Hn(t, e, i, s) {
            ...
            (t, e, i, s) : function (t, e, i, s) {
                ...
                a = Wn(e);
                for (const r of n)
                    In(t, o, r.style), t.beginPath(), a(t, e, r, {
                        start: i,
                        end: i + s - 1
            ...
            beforeElementsUpdate: (t, e, i) => {
                ...
                t.data.datasets.forEach(((e, n) => {
                        ...
                        let {
                            ...
                            return l && (n = Ht(oe(e, o.axis, a).lo, 0, i - 1)),
        ...
        function oo(t) {
            return (t.scale || {}).getPointPositionForValue ? function (t) {
                ...
                if (c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), s.grid.circular)
                    return h = e.getPointPositionForValue(0, a), new no({
                        x: h.x,
                        y: h.y,
        ...
        var yo = {
            ...
            afterDatasetsUpdate(t, e, i) {
                ...
                l;
                for (a = 0; a < s; ++a)
                    o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof jn && (l = {
        ...
        class wo extends Ms {
            ...
            _draw() {
                ...
                this.legendItems.forEach(((w, M) => {
                        ...
                        _ ? M > 0 && D + P + u > this.right && (C = p.y += v, p.line++, D = p.x = n(a, this.left + u, this.right - i[p.line])) : M > 0 && C + v > this.bottom && (D = p.x = D + e[p.line].width + u, p.line++, C = p.y = n(a, this.top + y + u, this.bottom - e[p.line].height));
                        !function (t, e, i) {
                            ...
                            if (s.fillStyle = K(i.fillStyle, l), s.lineCap = K(i.lineCap, "butt"), s.lineDashOffset = K(i.lineDashOffset, 0), s.lineJoin = K(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = K(i.strokeStyle, l), s.setLineDash(K(i.lineDash, [])), r.usePointStyle) {
                                ...
                                r = Fe(i.borderRadius);
                                s.beginPath(),
                                Object.values(r).some((t => 0 !== t)) ? se(s, {
                                    x: a,
                                    y: o,
                                    w: m,
                                    h: x,
        ...
        class Vo extends Ms {
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = zo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = Ve(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r)
            ...
            drawBody(t, e, i) {
                ...
                for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = zo(this, p, i), e.fillStyle = i.bodyColor, J(this.beforeBody, g), u = a && "right" !== p ? "center" === o ? l / 2 + h : l + 2 + h : 0, _ = 0, v = s.length; _ < v; ++_) {
                    for (m = s[_], x = this.labelTextColors[_], e.fillStyle = x, J(m.before, g), b = m.lines, a && b.length && (this._drawColorBox(e, t, _, f, i), d = Math.max(c.lineHeight, r)), y = 0, w = b.length; y < w; ++y)
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = zo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = Ve(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a)
            ...
            handleEvent(t, e) {
                ...
                return n = e || !tt(o, s) || a,
                n && (this._active = o, (i.enabled || i.external) && (this._eventPosition = {
                            x: t.x,
                            y: t.y
                        }, this.update(!0, e))),
                n
        ...
        class Yo extends Es {
            ...
            buildTicks() {
                ...
                const s = function (t, e) {
                    ...
                    m && x && n && Lt((a - o) / n, k / 1e3) ? (M = Math.round(Math.min((a - o) / k, h)), k = (a - o) / M, v = o, w = a) : b ? (v = m ? o : v, w = x ? a : w, M = l - 1, k = (w - v) / M) : (M = (w - v) / k, M = Tt(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M));
                    ...
                    for (m && (d && v !== o ? (i.push({
                                    value: o
                                }), v < o && P++, Tt(Math.round((v + P * k) * y) / y, o, $o(o, _, t)) && P++) : v < o && P++); P < M; ++P)
                        i.push({
                ...
                return "ticks" === t.bounds && Rt(s, this, "value"),
        ...
        class qo extends Es {
            ...
            buildTicks() {
                ...
                return "ticks" === t.bounds && Rt(e, this, "value"),
        ...
        function ea(t, e, i, s) {
            ...
            if (i)
                n.arc(t.xCenter, t.yCenter, e, 0, _t);
            else {
        ...
        class da extends Es {
            ...
            _generate() {
                ...
                for (c = u, d = 0; c < i; c = +t.add(c, a, o), d++)
                    ha(h, c, f);
                return c !== i && "ticks" !== s.bounds && 1 !== d || ha(h, c, f),
        ...
        return an.register(Cn, ga, Jn, No),
        an.helpers = {
            ...Hi
        },
        an._adapters = dn,
